...
$this->title = Yii::t('mailchimp', 'Member') . ': ' . $model->email_address;
...
?>
<div class="mailchimp-list-member-view container">

    <p>
        <?= Html::a( '<i class="glyphicon glyphicon-remove"></i> ' . Yii::t('mailchimp', 'Delete') , ['delete', 'id' => $model->id, 'list_id' => $model->list_id], [
