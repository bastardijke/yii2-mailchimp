...
$this->title = Yii::t('mailchimp', 'List').': '.$model->name.' ('.$model->id.')';
...
<div class="mailchimp-list-view">

    <p>
        <?= Html::a( '<i class="glyphicon glyphicon-plus"></i> ' . Yii::t('mailchimp', 'Create'),
	        ['member/create', 'list_id' => $model->id ],
        ...
        'columns' => [
            ...
            [
				...
				'urlCreator'=>function($action, $model, $key, $index){
					return [ 'member/'.$action, 'id' => $model['id'] , 'list_id' => $model['list_id'] ];
				},
            ],
