...
$this->title = Yii::t('mailchimp', 'Campaigns') . ': ' . $campaign['id'];
$this->params['breadcrumbs'][] = ['label' => Yii::t('mailchimp', 'Mailchimp'), 'url' => ['default/index']];
$this->params['breadcrumbs'][] = ['label' => Yii::t('mailchimp', 'Campaigns'), 'url' => ['campaign/index']];
$this->params['breadcrumbs'][] = $this->title;

?>
<div class="mailchimp-campaign container">
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            'settings.use_conversation:boolean', 
            ...
            'settings.drag_and_drop:boolean',
            ...
            'delivery_status.can_cancel:boolean',
