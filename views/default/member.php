...
$this->title = Yii::t('mailchimp', 'Member') . ': ' . $member['id'];
...
$this->params['breadcrumbs'][] = ['label' => Yii::t('mailchimp', 'List'), 'url' => ['list' , 'id' => $member['list_id']]];
$this->params['breadcrumbs'][] = $this->title;

?>
<div class="mailchimp-member container"> 
    <?= DetailView::widget([
        'model' => $member,
        'attributes' => [
